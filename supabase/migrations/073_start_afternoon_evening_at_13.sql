-- Migration 073: Start the combined afternoon/evening window at 13:00.
...
begin
  ...
  v_completion_window_end := case
    when v_task.time_window = 'morning' then p_day_start + interval '13 hours'
...
begin
  ...
  where tc.user_id = p_user_id
    ...
    and tc.completed_at < case
      when dt.time_window = 'morning' then p_day_start + interval '13 hours'
      else p_day_start + interval '1 day'
    end;
