...
export const KIND_CATALOG: KindOption[] = [
  { id: 'dino',     ko: '공룡 탐험가',  en: 'Dino Explorer', emoji: '🦖', hint: 'boy' },
  { id: 'spaceman', ko: '우주인',       en: 'Spaceman',      emoji: '🚀', hint: 'boy' },
  { id: 'kitty',    ko: '아기 고양이',  en: 'Kitty',         emoji: '🐱', hint: 'girl' },
  { id: 'puppy',    ko: '강아지',       en: 'Puppy',         emoji: '🐶', hint: 'girl' },
];
